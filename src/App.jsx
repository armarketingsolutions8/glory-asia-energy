        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-12">
            ...
            <div className="hidden lg:flex space-x-7 items-center">
              ...
              <a href="#workpack" className="text-xs font-extrabold tracking-wider uppercase transition-colors text-[#183058] hover:text-[#F29631]">Workpacks</a>
              <a href="#contact" className="bg-[#F29631] text-white px-6 py-2.5 rounded-full text-xs font-extrabold tracking-wider uppercase hover:bg-orange-500 transition-all shadow-md shadow-orange-500/30 hover:shadow-orange-500/50 hover:-translate-y-0.5">
                Partner With Us
              </a>
            </div>

            {/* Mobile Menu Button - Dark Navy Icon */}
            <div className="lg:hidden flex items-center">
              <button onClick={toggleMenu} className="focus:outline-none transition-colors text-[#183058]">
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white border-t border-slate-200 absolute w-full shadow-2xl mt-2 pb-4 px-4 animate-in slide-in-from-top-2 duration-300">
            <div className="flex flex-col space-y-1 mt-2 text-center">
              ...
              <a href="#workpack" onClick={toggleMenu} className="block px-4 py-2.5 text-[#183058] text-sm font-extrabold tracking-wide uppercase hover:bg-slate-100 rounded-xl transition-colors">Workpacks</a>
